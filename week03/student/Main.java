...
public class Main {
    private static final EntityManagerFactory myEMF = HibernateConfig.getEntityManagerFactoryConfig();

    public static void main(String[] args) {
        Student s1 = new Student();
        Student s2 = new Student();
        s1.setEmail("Test9@student.one");
        createStudent(s1);
        //// Disabled due to not wanting to need a try catch at every createStudent and I can't put the try catch in the function.
        //createStudent(s2);
